...
namespace projectEntity.Migrations
{
    public partial class BasicStructure : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Tarea",
                columns: new[] { "tareaId", "Descripcion", "Titulo", "categoriaId", "prioridad" },
                values: new object[] { new Guid("74a70252-5c9c-4f39-bb8c-058fe6f02ce0"), "Ejercicios de piernas con pesas de 5kg, desplazamiento delantero y trasero", "Ejercicios de piernas", new Guid("2799307e-9ba5-4ee4-859c-e909339206d0"), 2 });

            migrationBuilder.InsertData(
                table: "Tarea",
                columns: new[] { "tareaId", "Descripcion", "Titulo", "categoriaId", "prioridad" },
                values: new object[] { new Guid("dbfc07f7-bebf-4b66-a56f-5e7090f75511"), "Tarea de ciencias naturales sobre el cuerpo humano", "Hacer la tarea de ciencias naturales", new Guid("89a4a2cb-0b25-4373-a558-066525e4334a"), 2 });
